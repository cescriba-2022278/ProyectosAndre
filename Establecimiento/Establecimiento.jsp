<%-- 
    Document   : Empleado
    Created on : 20/07/2023, 01:53:36 PM
    Author     : informatica
--%>
            ...
            <div class="card col-sm-4">
                    <form action="Controlador?menu=Establecimiento" method="POST">
                        <div class="form-group">
                            <label>DPI:</label>
                            <input type="text" value="${empleado.getDPIEmpleado()}" name="txtNombreEstablecimiento" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Nombre:</label>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" onclick="return confirm('Desea eliminar este registro')" href="Controlador?menu=Establecimiento&accion=Eliminar&idEstablecimiento=${establecimiento.getIdEstablecimiento()}">Eliminar</a>
                            </td>
                        </tr>
                        </c:forEach>
                    </tbody>
